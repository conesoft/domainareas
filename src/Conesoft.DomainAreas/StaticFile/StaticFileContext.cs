...
using Conesoft.AspNetCore.Builder;
using Conesoft.AspNetCore.Internal;
...
namespace Conesoft.AspNetCore.StaticFiles
{
    internal struct StaticFileContext
    {
        ...
        {
            return _options.ShouldSkip(new StaticFileResponseContext(_context, _fileInfo));
        }
